...
export async function generateMetadata({ params: { locale } }) {
  ...
  const title = t('metatags.user.forgot_password.title', { domain: domainName })
  const description = t('metatags.user.forgot_password.description', { domain: domainName })
  const imgAlt = t('metatags.user.forgot_password.img_alt', { domain: domainName })

  const alternates = getAlternates({ pageUrl: 'forgot-password', domain, lang: locale })
  ...
  return {
    ...
    openGraph: {
      title: title,
      description: description,
      url: `https://${domain}/forgot-password`,
