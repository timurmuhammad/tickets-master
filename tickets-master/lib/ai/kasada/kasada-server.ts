...
const kasadaAPIURL = `https://${kasadaAPIEndpoint}/ai/149e9513-01fa-4fb0-aad4-566afd725d1b/2d206a39-8ed7-437e-a3be-862e0f06eea3/api/${kasadaAPIVersion}/classification`
...
async function getKasadaMetadata(request: NextRequest): Promise<{
  ...
  const headersArray = Array.from(headers.entries()).map(([key, value]) => ({
    key,
    value
  }))
