  ...
  return (
    ...
    >
      <div className="col-sm-8 col-md-7 col-lg-6 col-xl-4 col-xxl-3 col-12 rounded-12 border-light bg-white px-20 pb-20 pt-24 shadow-4">
        <h1 className="text-25 fw-600 mb-10">Please log in to continue</h1>
        <div className="w-100">
          <div>
            <label
          ...
          <div className="mt-5">
            <Link
              ...
              className="p-0 col text-13 text-blue-4 fw-700"
            >
      ...
      <div className="col-12 row m-0 py-20">
        ...
        >
          No account yet? <div className="fw-700 underline">Sign up</div>
        </Link>
      </div>
    </form>
  )
...
function LoginButton({ isLoading}) {
  return (
    <button
      type="submit"
      className="button mt-20 d-flex w-100 py-12 flex-row align-items-center justify-center rounded-10 text-15 fw-600 bg-blue-1 -blue-4 text-light"
      disabled={isLoading}
    >
      {isLoading ? iconSpinner : 'Log in'}
    </button>
  )
}
